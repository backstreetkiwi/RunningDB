...
import de.zaunkoenigweg.runningdb.model.TrainingReport;
...
public class ReportUi extends AbstractUi {
    ...
    public ReportUi() {
        ...
        table.addGeneratedColumn("pace", new Table.ColumnGenerator() {
            ...
            public Object generateCell(Table source, Object itemId, Object columnId) {
                ...
                Integer schnitt = StatisticsUtil.getPace(trainingReportRow.getDistance(), trainingReportRow.getTime());
    ...
    public void show() {
        ...
        table.setColumnFooter("pace", TIME_CONVERTER.convertToPresentation(StatisticsUtil.getPace(traininigReport.getSumRow().getDistance(), traininigReport.getSumRow().getTime()), String.class, null));
