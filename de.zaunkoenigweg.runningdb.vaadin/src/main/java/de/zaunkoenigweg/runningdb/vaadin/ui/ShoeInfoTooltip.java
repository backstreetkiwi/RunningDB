...
public class ShoeInfoTooltip extends Window {
     ...
     */
    private ShoeInfoTooltip(final ShoeStatistics shoeInfo, int positionX, int positionY) {
     ...
     * @param positionY y-coordinate of desired tooltip position
     */
    public static void show(ShoeStatistics shoeInfo, int positionX, int positionY) {
